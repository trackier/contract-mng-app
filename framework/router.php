...
namespace Framework {
    ...
    class Router extends Base {
        ...
        protected function _pass($controller, $action, $parameters = array()) {
            ...
            $controllerPath = sprintf('%s/application/controllers/%s.php', APP_PATH, strtolower($name));
            $validClassName = preg_match('/^([a-zA-Z]+)$/', $controller);
            if (! $validClassName || ! file_exists($controllerPath) || ! class_exists($name)) { // because PHP does not catch fatal errors - Class Not found
